...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addImage(shooterImg)
   player.scale = 0.3
   //player.debug = true
   player.setCollider("rectangle",0,0,225,480)


   //creating sprites to depict lives remaining
   heart1 = createSprite(displayWidth-145,40,20,20)
...
if(player.y > 100 && keyDown("UP_ARROW")||touches.length>0){
  player.y = player.y-30
}
if(player.y < windowHeight -99 && keyDown("DOWN_ARROW")||touches.length>0 ) {
 player.y = player.y+30
}
...
textSize(30)
fill("")
text("Score : "+score, displayWidth-450,45);
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie.velocityX = -3
    //zombie.debug= true
    zombie.setCollider("rectangle",0,0,420,960)
